...
%-----------CENTERED TEXT-----------------
\begin{justify}
  % \small{Research scientist with 7+ years of experience with AI and Machine Learning at the intersection of hardware and software. Currently leading innovations in ML-powered chip design at Huawei. Expertise spans EDA automation, transformer-based AI models, and energy-efficient hardware accelerators. I am able to explain how to build a Tensor Processing Unit from the sand and how to program it.}
  \small{AI \& HW Research Scientist with 7+ years of experience in ML and Chip Design, currently leading innovations in ML-powered chip design at Huawei. Expertise spans ML for chip design and logic synthesis optimization, EDA automation, energy-efficient HW accelerators design, 2D/3D computer vision, transformer-based networks, large-scale workload distribution on multi-node servers.}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {AI \& HW Research Scientist}{May 2024 - Present}
      \resumeItemListStart
        ...
        \item{Designed and developed an automated ML-based framework to generate multipliers with reduced switching activity and lower power consumption.\vspace{-2pt}}
        \item{Deployed synthesis and simulation of millions of designs using containerized (Docker), open source EDA tools and commercial EDA tools on a multi-node SLURM cluster.\vspace{-2pt}}
        ...
        \resumeItemTitleAndStart{Characterization of ML Workloads Acceleration}
          ...
          \item{Utilized the simulator to benchmark tensor reshaping and vector reordering strategies, proposing novel software-level optimizations that effectively reduce power consumption.\vspace{-2pt}}
        \end{itemize}
...
\begin{itemize}[leftmargin=*, topsep=0pt, label=$\circ$]
   \item
     \textbf{Languages}{: Python, C/C++, SystemVerilog, MATLAB, VHDL}\vspace{-10pt}
   \item
     \textbf{Libraries}{: PyTorch, MLFlow, ONNX, CUDA, OpenCV, ROS, Dash, Flask, concurrent}\vspace{-10pt}
   \item
     \textbf{Hardware \& EDA Tools}{: CocoTB, Yosys, OpenRoad, ABC, Mockturtle, Verilator, Design Compiler, QuestaSim, PrimeTime Power, PowerPro, Innovus}\vspace{-10pt}
   \item
     \textbf{Software \& DevOps}{: Docker, Git, Continuous Integration (CI)}
  \end{itemize}
...
\begin{itemize}[leftmargin=*, topsep=0pt, label=$\circ$]
  \item M. Bouvier, et al., ``GENIAL: \textbf{G}enerative Design Space \textbf{E}xploration via \textbf{N}etwork \textbf{I}nversion for Low Power \textbf{A}lgorithmic \textbf{L}ogic Units,'' \textit{Under Review}, 2025.
  \vspace{-10pt}
  \item F. Arnold, et al., ``Explicit Sign-Magnitude Encoders Enable Power-Efficient Multipliers,'' \textit{International Workshop on Logic and Synthesis}, 2025.
  \vspace{-10pt}
  \item F. Arnold, et al., \href{https://arxiv.org/abs/2502.17936}{``The Art of Beating the Odds with Predictor-Guided Random Design Space Exploration,'' \textit{62nd ACM/IEEE Design Automation Conference (DAC) (Poster)}}, 2025.
  \vspace{-10pt}
  \item C. M. Turrero, et al., \href{https://dl.acm.org/doi/abs/10.5555/3692070.3694066}{``ALERT-Transformer: Bridging Asynchronous and Synchronous Machine Learning for Real-Time Event-based Spatio-Temporal Data,'' \textit{Proceedings of the 41st International Conference on Machine Learning (ICML)}}, 2024.
  \vspace{-10pt}
  \item M. Bouvier, et al., \href{https://ieeexplore.ieee.org/document/9586099}{``Scalable pitch-constrained neural processing unit for 3D integration with event-based imagers,'' \textit{2021 58th ACM/IEEE Design Automation Conference (DAC)}}, 2021.
  \vspace{-10pt}
  \item M. Bouvier, \href{https://theses.hal.science/tel-03405455/}{``Study and design of an energy-efficient perception module combining event-based image sensors and spiking neural network with 3D integration technologies,'' \textit{Ph.D. Dissertation, Universit\'e Grenoble Alpes}}, 2021.
  \vspace{-10pt}
  \item M. Bouvier, et al., \href{https://dl.acm.org/doi/abs/10.1145/3304103}{``Spiking neural networks hardware implementations and challenges: A survey,'' \textit{ACM Journal on Emerging Technologies in Computing Systems (JETC)}}, 2019.
  \vspace{-10pt}
  \item P. Vivet, et al., \href{https://ieeexplore.ieee.org/abstract/document/8714886/}{``Advanced 3D technologies and architectures for 3D smart image sensors,'' \textit{2019 Design, Automation \& Test in Europe Conference \& Exhibition (DATE)}}, 2019.
\end{itemize}
