  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item{Designed and developed \href{https://github.com/huawei-csl/GENIAL}{\textbf{GENIAL}}: ML framework for iterative generation of multiplier circuits with reduced switching activity. Accepted at ASP-DAC 2026. (\textit{1 paper.})\vspace{-2pt}}
        \item{Built \href{https://github.com/huawei-csl/oss_eda_base}{\textbf{oss\_eda\_base}}: Docker base image bundling open-source EDA tools (Yosys, ABC, Verilator) for reproducible synthesis pipelines on SLURM clusters.\vspace{-2pt}}
        \item{Proved that Network Inversion outperforms other state-of-the-art methods for design generation and design space exploration.\vspace{-2pt}}
        \item{Results: achieved up to 18\% switching activity reduction in multipliers on AI workloads compared to conventional two's complement encoding.\vspace{-2pt}}
        \end{itemize}
...
\begin{itemize}[leftmargin=*, topsep=0pt, label=$\circ$]
  \begin{small}
  \item M. Bouvier, R. Amaudruz, F. Arnold, R. Andri, L. Cavigelli, \href{https://github.com/huawei-csl/GENIAL}{``\textbf{GENIAL: Generative Design Space Exploration via Network Inversion for Low Power Algorithmic Logic Units},''} \textit{31st Asia and South Pacific Design Automation Conference (ASP-DAC)}, 2026.
  \vspace{-7pt}
