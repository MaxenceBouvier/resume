  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemTitleAndStart{SW/HW Co-Design Automation with Neural Architecture Search}
          \item{Implemented an AI model leveraging CNN and Transformer architectures to enhance video sequence continuity through advanced frame generation. - (\textit{1 patent.})\vspace{-2pt}}
          ...
          \item{Converted to the model as an API to simplify sharing across teams and projects.\vspace{-2pt}}
        \end{itemize}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemTitleAndStart{CPU Deisgn and Automation}
          ...
          \item{Developed an RTL generator for STM32 MPU SoC, streamline the design of a multi-clock domain reset and clock control for over 300 peripherals.\vspace{-2pt}}
        \end{itemize}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{ULP IC Design for Sparse AI Acceleration}
          {Built a 28nm FDSOI ultra-low power sparse AI accelerator, setting energy efficiency records and enabling seamless Event-Based pixel grid integration. - (\textit{1 paper, 2 patents.})}
        \resumeItem{EB VIO/SLAM Pipeline and Object Detection Innovation}
          {Developed an Event-Based VIO/SLAM pipeline with ego-motion compensation, leading to a patent and a solution for moving objects detection. - (\textit{1 patent.})}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item\small{Contributed to the optimization of PCM technologies for Compute-in-Memory-based AI accelerarion. - (\textit{1 paper, 1 patent.})\vspace{-2pt}}
      \resumeItemListEnd
...
\begin{itemize}[leftmargin=*, topsep=0pt]
   \item
     \textbf{Languages}{: Python, C, C++, SystemVerilog, VHDL, MATLAB, LaTeX}\vspace{-10pt}
   \item
     \textbf{Libraries}{: PyTorch, ONNX, Numpy, Pandas, ROS, OpenCV}\vspace{-10pt}
   \item
     \textbf{Softwares}{: Git, VScode, EDA (Cadence, Synopsys, Mentor), PowerPoint Expert}\vspace{-10pt}
  \end{itemize}
