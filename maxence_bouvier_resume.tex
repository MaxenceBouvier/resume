    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{ML for Advanced Synthesis}
          {Built a predictor-based synthesis framework that demonstrated state of the art quality of results by improving previous method by up to 20.94\% in synthesis quality but by up to 14x in overall speed - (\textit{1 paper})\vspace{-2pt}}
...
\begin{itemize}[leftmargin=*, topsep=0pt]
   ...
   \item
     \textbf{Libraries}{: PyTorch, MLFlow, ONNX, Numpy, Dash, Pandas, CocoTB, ROS, OpenCV, CUDA}\vspace{-10pt}
   \item
     \textbf{Softwares}{: Git, CI, Docker, OSS EDA (Yosys, OpenRoad, Verilator), EDA (Cadence, Synopsys, Mentor), PowerPoint}\vspace{-10pt}
  \end{itemize}
