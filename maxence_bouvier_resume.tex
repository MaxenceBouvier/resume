...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Research Scientist | AI for chip design}{May 2024 - Present}
      \resumeItemListStart
        \resumeItem{Team Leader}
          {Conducted recruitment of multi-disciplinary experts and led us to success on the project's objectives of proposing solutions to reduce switching activity (and ultimately power consumption) inside Huawei's GPUs.\vspace{-2pt}}
        \resumeItem{ML for Chip Design}
          {Designed a pipeline for generating low switching activity multiplier units in Verilog by inverting a transformer-based network trained to predict the average switching activity of millions of designs. Automated the synthesis and simulation of million of designs using containerized open source EDA tools (Yosys, OpenRoad, Verilator) - (\textit{1 paper (WIP)})\vspace{-2pt}}
        \resumeItem{ML for Advanced Synthesis}
          {Developed a predictor-driven synthesis framework achieving up to 21\% higher quality and 14x faster execution, advancing industry benchmarks in chip design optimization - (\textit{1 paper})\vspace{-2pt}}
        \resumeItem{ML Workload Characterization on GPUs}
    ...
    \resumeSubheading
      ...
      {Senior AI Research Engineer - Hardware Aware Computer Vision}{Aug 2023 - Apr 2024}
      \resumeItemListStart
    ...
    \resumeSubSubheading
      {AI Research Engineer - Hardware Aware Computer Vision}{June 2022 - Aug 2023}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Digital IC Design Engineer - Energy Efficient Systems-on-Chip}{Apr 2021 - May 2022}
      \resumeItemListStart
...
\begin{itemize}[leftmargin=*, topsep=0pt]
   ...
   \item
     \textbf{Libraries}{: PyTorch, MLFlow, ONNX, CUDA, OpenCV, ROS, Dash, Flask}\vspace{-10pt}
   \item
     \textbf{Hardware \& EDA Tool}{: Yosys, OpenRoad, Verilator, Synopsys DC, Cadence Innovus}\vspace{-10pt}
   \item
...
\begin{itemize}[leftmargin=*, topsep=0pt]
  ...
  \vspace{-10pt}
  \item M. Bouvier, et al., ``Scalable pitch-constrained neural processing unit for 3D integration with event-based imagers,'' \textit{2021 58th ACM/IEEE Design Automation Conference (DAC)}, 2021.
  \vspace{-10pt}
  \item M. Bouvier, \href{https://theses.hal.science/tel-03405455/}{``Study and design of an energy-efficient perception module combining event-based image sensors and spiking neural network with 3D integration technologies,'' \textit{Ph.D. Dissertation, Université Grenoble Alpes}}, 2021.
  \vspace{-10pt}
