  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemTitleAndStart{Sparsity Exploitation in Transformers}
          \item{Engineered an asynchronous PointNet-based embedding, enabling continuous spatio-temporal data conversion into dense tensors for seamless, ongoing feeding of Transformer models - \textit{Publication (WIP).}\vspace{-2pt}}
          \item{Designed a NPU-adapted sparse scaled-dot-product-attention per-block module for highly efficient sparse attention in Transformers, achieving moer than 50\% FLOPs reduction during inference and higher accuracy.\vspace{-2pt}}
        \end{itemize}
        
        \resumeItem{SLAM Enhanced AI Training}
          {Optimized the training pipeline by integrating a state-of-the-art SLAM pipeline with ego-motion compensation, leading to 6x faster model convergence and a 15\% increase in accuracy.}
    ...
    \resumeSubSubheading
      ...
      \resumeItemListStart
        \resumeItemTitleAndStart{SW/HW Co-Design Automation with Neural Architecture Search}
          ...
          \item{Integrated a Design Space Exploration software in thas NAS to estimate energy and latency of model execution.\vspace{-2pt}}
        \end{itemize}
        ...
        \resumeItem{Vision Transformer Design}
          {Implemented an AI model leveraging CNN and Transformer architectures to enhance video sequence continuity through advanced frame generation. \textit{(1 patent).}}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Reset and Clock Controller Generator}
          {Developed an RTL generator for STM32 MPU SoC, automating multi-clock domain reset and clock control for over 300 peripherals.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{ULP IC Design for Neuromorphic Acceleration}
          {Built a 28nm FDSOI ultra-low power neuromorphic accelerator, setting energy efficiency records and enabling seamless EB pixel grid integration. \textit{(1 paper, 2 patents.)}}
        \resumeItem{EB VIO/SLAM Pipeline and Object Detection Innovation}
          {Developed an Event-Based VIO/SLAM pipeline with ego-motion compensation, leading to a patent and improved perception accuracy. - \textit{1 patent.}}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item\small{Contributed to the optimization of PCM technologies for Compute-in-Memory AI accelerarion. - \textit{1 paper, 1 patent.}\vspace{-2pt}}
      \resumeItemListEnd
...
\begin{itemize}[leftmargin=*, topsep=0pt]
   \item
     \textbf{Languages}{: Python, C, C++, SystemVerilog, VHDL, MATLAB}\vspace{-10pt}
   \item
     \textbf{Technologies}{: PyTorch, ONNX, ROS, Xilinx FPGAs, }\vspace{-10pt}
   \item
     \textbf{Tools}{: Git, VScode, EDA (Cadence, Synopsys, Mentor), LaTeX}\vspace{-10pt}
  \end{itemize}
...
\section{Education}
  \begin{itemize}[leftmargin=*, topsep=0pt]
    ...
    \resumeEducationSubheading
      ...
      {B.Eng. in Electronics}{Sep 2015 -- Sep 2017}
  \end{itemize}
